...
class Vector2:
    ...
    def __init__(
        self,
        x: float | list[float] | tuple[float, float] = 0,
        y: float = 0,
    ) -> None:
        """Initialize Vector."""
    ...
    def __str__(self) -> str:
        """Return representation of vector as a point away from (0, 0)."""
    ...
    def from_points(
        cls,
        frompoint: Iterable[int | float] | Vector2,
        topoint: Vector2,
    ) -> Any:
    ...
    def get_distance_to(
        self,
        point: Iterable[int | float] | Vector2,
    ) -> float:
    ...
    def __add__(self, rhs: Vector2) -> Vector2:
        """Return new vector after adding rhs to self."""
        return self.__class__(self.x + rhs.x, self.y + rhs.y)

    def __sub__(self, rhs: Vector2) -> Vector2:
        """Return new vector after subtracting rhs from self."""
        return self.__class__(self.x - rhs.x, self.y - rhs.y)
    ...
    def __mul__(self, scalar: float) -> Vector2:
        """Return multiplication of components by scalar as new vector."""
        return self.__class__(self.x * scalar, self.y * scalar)

    def __truediv__(self, scalar: float) -> Vector2:
        """Return division of components by scalar as new vector."""
        try:
    ...
    def __eq__(self, rhs: object) -> bool:
        """Return if this object is equal to rhs."""
